...
public class ClosingBracketSectionParser implements SectionParser {

	private static final SectionParseResult SUCCESS = new SectionParseResult(1, null, true, true, false, true, false);
